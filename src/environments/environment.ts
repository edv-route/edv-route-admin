...
export const environment = {
  // ⚠️ TEMPORAL (2026-08-13, actualizado el 2026-08-26 a la cuenta nueva de
  // Railway — la anterior está apagada y su URL responde 404):
  // apuntado al backend de INTERNET para
